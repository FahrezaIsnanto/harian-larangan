...
<nav class="navbar navbar-light navbar-expand-lg navbar-light bg-light fixed-top home">
   <div class="container">
      <a href="<?= base_url() ?>" class="navbar-brand d-flex align-items-center w-50 mr-auto">
         <img src="<?= base_url('images/brand/logo-brand.png') ?>" width="50" height="50" class="d-inline-block align-top" alt="">
         HARIAN LARANGAN
      </a>
